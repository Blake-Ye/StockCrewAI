...
_POLICY_TABLE: dict[IssuerProfile, tuple[_MetricSpec, ...]] = {
    ...
    IssuerProfile.BANK: (
        ...
        _spec(
            ...
            gate_effect=_BLOCKING,
            reason_code="required_net_interest_margin",
        ),
        _spec(
            "pe_ratio",
            _NOT_APPLICABLE,
    ...
    IssuerProfile.INSURANCE: (
        _spec(
            ...
            gate_effect=_BLOCKING,
            reason_code="required_loss_ratio",
        ),
        _spec(
            "combined_ratio",
            _REQUIRED,
            ("incurred_losses", "operating_expenses", "earned_premiums"),
            gate_effect=_BLOCKING,
            reason_code="required_combined_ratio",
        ),
        _spec(
            "pe_ratio",
            _NOT_APPLICABLE,
            ("market_price", "diluted_eps"),
            gate_effect=_NON_BLOCKING,
            reason_code="not_applicable_insurance_pe_ratio",
        ),
    ),
    IssuerProfile.REIT: (
        _spec(
