...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            IssuerProfile.BANK,
            ("bank_roa", "net_interest_margin", "pe_ratio", "fcf_yield"),
            {
        ...
        (
            ...
            ("loss_ratio", "combined_ratio", "pe_ratio"),
            {
        ...
        (
            IssuerProfile.REIT,
            ("ffo_per_share", "affo_per_share", "pe_ratio"),
            {
                "ffo_per_share": Applicability.REQUIRED,
                "affo_per_share": Applicability.REQUIRED,
                "pe_ratio": Applicability.OPTIONAL,
            },
        ),
        (
